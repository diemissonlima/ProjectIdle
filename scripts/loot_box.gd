...
@export var loot_box2: VBoxContainer
@export var max_messages: int = 5
@export var font: Font


func add_message(target: String, message: String, color: Color = Color.WHITE) -> void:
	...
	elif target == "lootbox_2":
		new_label.text_direction = Control.TEXT_DIRECTION_RTL
